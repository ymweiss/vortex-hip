#!/bin/bash
# Run mstress_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/mstress_test" ]; then
...
# Parse arguments - forward all args to mstress_test
echo "Running: ./mstress_test $@"
echo "=========================================="
echo ""
