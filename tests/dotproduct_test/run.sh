#!/bin/bash
# Run dotproduct_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/dotproduct_test" ]; then
...
echo "=========================================="
echo "Vortex HIP dotproduct Test"
echo "=========================================="
...
# Parse arguments - forward all args to dotproduct_test
echo "Running: ./dotproduct_test $@"
echo "=========================================="
echo ""
