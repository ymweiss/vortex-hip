#!/bin/bash
# Run printf_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/printf_test" ]; then
...
# Parse arguments - forward all args to printf_test
echo "Running: ./printf_test $@"
echo "=========================================="
echo ""
