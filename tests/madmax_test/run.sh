#!/bin/bash
# Run madmax_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/madmax_test" ]; then
...
# Parse arguments - forward all args to madmax_test
echo "Running: ./madmax_test $@"
echo "=========================================="
echo ""
