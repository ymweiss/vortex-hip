#!/bin/bash
# Run conv3_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/conv3_test" ]; then
...
# Parse arguments - forward all args to conv3_test
echo "Running: ./conv3_test $@"
echo "=========================================="
echo ""
