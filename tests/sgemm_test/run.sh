#!/bin/bash
# Run sgemm_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/sgemm_test" ]; then
...
echo "=========================================="
echo "Vortex HIP SGEMM (Matrix Multiplication) Test"
echo "=========================================="
...
# Parse arguments - forward all args to sgemm_test
echo "Running: ./sgemm_test $@"
echo "=========================================="
echo ""
