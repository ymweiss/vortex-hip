#!/bin/bash
# Run io_addr_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/io_addr_test" ]; then
...
# Parse arguments - forward all args to io_addr_test
echo "Running: ./io_addr_test $@"
echo "=========================================="
echo ""
