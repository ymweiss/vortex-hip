#!/bin/bash
# Run diverge_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/diverge_test" ]; then
...
# Parse arguments - forward all args to diverge_test
echo "Running: ./diverge_test $@"
echo "=========================================="
echo ""
