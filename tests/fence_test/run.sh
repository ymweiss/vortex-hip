#!/bin/bash
# Run fence_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/fence_test" ]; then
...
# Parse arguments - forward all args to fence_test
echo "Running: ./fence_test $@"
echo "=========================================="
echo ""
