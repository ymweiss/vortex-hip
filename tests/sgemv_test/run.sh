#!/bin/bash
# Run sgemv_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/sgemv_test" ]; then
...
# Parse arguments - forward all args to sgemv_test
echo "Running: ./sgemv_test $@"
echo "=========================================="
echo ""
