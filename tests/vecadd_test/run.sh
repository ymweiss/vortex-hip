#!/bin/bash
# Run vecadd_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/vecadd_test" ]; then
...
echo "=========================================="
echo "Vortex HIP Vector Addition Test"
echo "=========================================="
...
# Parse arguments - forward all args to vecadd_test
echo "Running: ./vecadd_test $@"
echo "=========================================="
echo ""
