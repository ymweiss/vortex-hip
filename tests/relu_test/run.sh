#!/bin/bash
# Run relu_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/relu_test" ]; then
...
echo "=========================================="
echo "Vortex HIP ReLU Activation Test"
echo "=========================================="
...
# Parse arguments - forward all args to relu_test
echo "Running: ./relu_test $@"
echo "=========================================="
echo ""
