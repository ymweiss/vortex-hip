#!/bin/bash
# Run cta_test with proper Vortex environment
...
# Parse arguments - forward all args to cta_test
echo "Running: ./cta_test $@"
echo "=========================================="
echo ""
