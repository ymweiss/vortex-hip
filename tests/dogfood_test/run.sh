#!/bin/bash
# Run dogfood_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/dogfood_test" ]; then
...
# Parse arguments - forward all args to dogfood_test
echo "Running: ./dogfood_test $@"
echo "=========================================="
echo ""
