#!/bin/bash
# Run sgemm2_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/sgemm2_test" ]; then
...
# Parse arguments - forward all args to sgemm2_test
echo "Running: ./sgemm2_test $@"
echo "=========================================="
echo ""
