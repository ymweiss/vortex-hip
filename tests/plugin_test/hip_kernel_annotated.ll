; ModuleID = 'hip_kernel_annotated.cpp'
source_filename = "hip_kernel_annotated.cpp"
...
@.str = private unnamed_addr constant [11 x i8] c"hip.kernel\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [25 x i8] c"hip_kernel_annotated.cpp\00", section "llvm.metadata"
@llvm.global.annotations = appending global [2 x { i8*, i8*, i8*, i32 }] [{ i8*, i8*, i8*, i32 } { i8* bitcast (void (float*, float*, float*, i32)* @_Z6vecaddPfS_S_i to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0), i32 26 }, { i8*, i8*, i8*, i32 } { i8* bitcast (void (i8, i16, i32, i64, float*, double*, i32)* @_Z11mixed_typescsilPfPdi to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0), i32 34 }], section "llvm.metadata"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @_Z15helper_functioni(i32 %x) #0 {
entry:
