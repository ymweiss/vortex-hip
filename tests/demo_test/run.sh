#!/bin/bash
# Run demo_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/demo_test" ]; then
...
# Parse arguments - forward all args to demo_test
echo "Running: ./demo_test $@"
echo "=========================================="
echo ""
