#!/bin/bash
# Run dropout_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/dropout_test" ]; then
...
# Parse arguments - forward all args to dropout_test
echo "Running: ./dropout_test $@"
echo "=========================================="
echo ""
