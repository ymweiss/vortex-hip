#!/bin/bash
# Run sgemm_tcu_test with proper Vortex environment
...
if [ ! -f "$SCRIPT_DIR/sgemm_tcu_test" ]; then
...
echo "=========================================="
echo "Vortex HIP sgemm_tcu Test"
echo "=========================================="
...
# Parse arguments - forward all args to sgemm_tcu_test
echo "Running: ./sgemm_tcu_test $@"
echo "=========================================="
echo ""
