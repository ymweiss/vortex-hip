module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", polygeist.gpu_module.llvm.data_layout = "e-i64:64-i128:128-v16:16-v32:32-n16:32:64", polygeist.gpu_module.llvm.target_triple = "nvptx64-nvidia-cuda", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  gpu.module @__polygeist_gpu_module {
    gpu.func @_Z17launch_dotproductPKfS0_Pfji_kernel93963319599504(%arg0: index, %arg1: i32, %arg2: i32, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>) kernel attributes {gpu.known_block_size = array<i32: 32, 1, 1>, nvvm.maxntidx = 32 : index, rocdl.max_flat_work_group_size = 32 : index} {
  ...
  func.func @_Z17launch_dotproductPKfS0_Pfji(%arg0: memref<?xf32>, %arg1: memref<?xf32>, %arg2: memref<?xf32>, %arg3: i32, %arg4: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    "polygeist.alternatives"() ({
      ...
      %8 = "polygeist.gpu_error"() ({
        ...
        scf.if %11 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z17launch_dotproductPKfS0_Pfji_kernel93963319599504 blocks in (%3, %7, %c1) threads in (%c32, %c1, %c1)  args(%4 : index, %arg4 : i32, %arg3 : i32, %arg0 : memref<?xf32>, %arg1 : memref<?xf32>, %arg2 : memref<?xf32>)
        }
      ...
      %8 = "polygeist.gpu_error"() ({
        ...
        %11 = arith.andi %9, %10 : i1
        scf.if %11 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z17launch_dotproductPKfS0_Pfji_kernel93963319698256 blocks in (%3, %7, %c1) threads in (%c64, %c1, %c1)  args(%4 : index, %arg4 : i32, %arg3 : i32, %arg0 : memref<?xf32>, %arg1 : memref<?xf32>, %arg2 : memref<?xf32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %8 = "polygeist.gpu_error"() ({
        ...
        %11 = arith.andi %9, %10 : i1
        scf.if %11 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z17launch_dotproductPKfS0_Pfji_kernel93963319734288 blocks in (%3, %7, %c1) threads in (%c128, %c1, %c1)  args(%4 : index, %arg4 : i32, %arg3 : i32, %arg0 : memref<?xf32>, %arg1 : memref<?xf32>, %arg2 : memref<?xf32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %8 = "polygeist.gpu_error"() ({
        ...
        %11 = arith.andi %9, %10 : i1
        scf.if %11 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z17launch_dotproductPKfS0_Pfji_kernel93963319741568 blocks in (%3, %7, %c1) threads in (%c256, %c1, %c1)  args(%4 : index, %arg4 : i32, %arg3 : i32, %arg0 : memref<?xf32>, %arg1 : memref<?xf32>, %arg2 : memref<?xf32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %8 = "polygeist.gpu_error"() ({
        ...
        %11 = arith.andi %9, %10 : i1
        scf.if %11 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z17launch_dotproductPKfS0_Pfji_kernel93963319746944 blocks in (%3, %7, %c1) threads in (%c512, %c1, %c1)  args(%4 : index, %arg4 : i32, %arg3 : i32, %arg0 : memref<?xf32>, %arg1 : memref<?xf32>, %arg2 : memref<?xf32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %8 = "polygeist.gpu_error"() ({
        ...
        %11 = arith.andi %9, %10 : i1
        scf.if %11 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z17launch_dotproductPKfS0_Pfji_kernel93963319757488 blocks in (%3, %7, %c1) threads in (%c1024, %c1, %c1)  args(%4 : index, %arg4 : i32, %arg3 : i32, %arg0 : memref<?xf32>, %arg1 : memref<?xf32>, %arg2 : memref<?xf32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
