module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, gpu.container_module, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", polygeist.gpu_module.llvm.data_layout = "e-i64:64-i128:128-v16:16-v32:32-n16:32:64", polygeist.gpu_module.llvm.target_triple = "nvptx64-nvidia-cuda", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  gpu.module @__polygeist_gpu_module {
    gpu.func @_Z14launch_io_addrPmPjjii_kernel94401910405936(%arg0: index, %arg1: i32, %arg2: i32, %arg3: memref<?xi64>, %arg4: memref<?xi32>) kernel attributes {gpu.known_block_size = array<i32: 32, 1, 1>, nvvm.maxntidx = 32 : index, rocdl.max_flat_work_group_size = 32 : index} {
      ...
      scf.if %12 {
        %13 = memref.load %arg3[%10] : memref<?xi64>
        %14 = llvm.inttoptr %13 : i64 to !llvm.ptr
        %15 = llvm.load %14 : !llvm.ptr -> i32
        memref.store %15, %arg4[%10] : memref<?xi32>
      }
      gpu.return
    }
  }
  func.func @_Z14launch_io_addrPmPjjii(%arg0: memref<?xi64>, %arg1: memref<?xi32>, %arg2: i32, %arg3: i32, %arg4: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    "polygeist.alternatives"() ({
      ...
      %5 = "polygeist.gpu_error"() ({
        ...
        %8 = arith.andi %6, %7 : i1
        scf.if %8 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z14launch_io_addrPmPjjii_kernel94401910405936 blocks in (%0, %4, %c1) threads in (%c32, %c1, %c1)  args(%1 : index, %arg4 : i32, %arg2 : i32, %arg0 : memref<?xi64>, %arg1 : memref<?xi32>)
        }
      ...
      %5 = "polygeist.gpu_error"() ({
        ...
        %8 = arith.andi %6, %7 : i1
        scf.if %8 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z14launch_io_addrPmPjjii_kernel94401912045056 blocks in (%0, %4, %c1) threads in (%c64, %c1, %c1)  args(%1 : index, %arg4 : i32, %arg2 : i32, %arg0 : memref<?xi64>, %arg1 : memref<?xi32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %5 = "polygeist.gpu_error"() ({
        ...
        %8 = arith.andi %6, %7 : i1
        scf.if %8 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z14launch_io_addrPmPjjii_kernel94401912078384 blocks in (%0, %4, %c1) threads in (%c128, %c1, %c1)  args(%1 : index, %arg4 : i32, %arg2 : i32, %arg0 : memref<?xi64>, %arg1 : memref<?xi32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %5 = "polygeist.gpu_error"() ({
        ...
        %8 = arith.andi %6, %7 : i1
        scf.if %8 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z14launch_io_addrPmPjjii_kernel94401912086720 blocks in (%0, %4, %c1) threads in (%c256, %c1, %c1)  args(%1 : index, %arg4 : i32, %arg2 : i32, %arg0 : memref<?xi64>, %arg1 : memref<?xi32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %5 = "polygeist.gpu_error"() ({
        ...
        %8 = arith.andi %6, %7 : i1
        scf.if %8 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z14launch_io_addrPmPjjii_kernel94401912092064 blocks in (%0, %4, %c1) threads in (%c512, %c1, %c1)  args(%1 : index, %arg4 : i32, %arg2 : i32, %arg0 : memref<?xi64>, %arg1 : memref<?xi32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
      ...
      %5 = "polygeist.gpu_error"() ({
        ...
        %8 = arith.andi %6, %7 : i1
        scf.if %8 {
          gpu.launch_func  @__polygeist_gpu_module::@_Z14launch_io_addrPmPjjii_kernel94401912082640 blocks in (%0, %4, %c1) threads in (%c1024, %c1, %c1)  args(%1 : index, %arg4 : i32, %arg2 : i32, %arg0 : memref<?xi64>, %arg1 : memref<?xi32>)
        }
        "polygeist.polygeist_yield"() : () -> ()
      }) : () -> index
      "polygeist.polygeist_yield"() : () -> ()
    }) {alternatives.descs = ["block_size=32,blockDims=x:32;y:1;z:1;,floatOps=,intOps=4:64;8:64;,loads=8/x:unk|y:unk|z:unk|/0:32;,stores=4/x:unk|y:unk|z:unk|/0:32;,", "block_size=64,blockDims=x:64;y:1;z:1;,floatOps=,intOps=4:128;8:128;,loads=8/x:unk|y:unk|z:unk|/0:64;,stores=4/x:unk|y:unk|z:unk|/0:64;,", "block_size=128,blockDims=x:128;y:1;z:1;,floatOps=,intOps=4:256;8:256;,loads=8/x:unk|y:unk|z:unk|/0:128;,stores=4/x:unk|y:unk|z:unk|/0:128;,", "block_size=256,blockDims=x:256;y:1;z:1;,floatOps=,intOps=4:512;8:512;,loads=8/x:unk|y:unk|z:unk|/0:256;,stores=4/x:unk|y:unk|z:unk|/0:256;,", "block_size=512,blockDims=x:512;y:1;z:1;,floatOps=,intOps=4:1024;8:1024;,loads=8/x:unk|y:unk|z:unk|/0:512;,stores=4/x:unk|y:unk|z:unk|/0:512;,", "block_size=1024,blockDims=x:1024;y:1;z:1;,floatOps=,intOps=4:2048;8:2048;,loads=8/x:unk|y:unk|z:unk|/0:1024;,stores=4/x:unk|y:unk|z:unk|/0:1024;,"], alternatives.type = "gpu_kernel", polygeist.altop.id = "+home+yaakov+vortex_hiploc(\22+tmp+polygeist_temp_io_addr_kernel.cu\22:17:3)_Z14launch_io_addrPmPjjii.func.0"} : () -> ()
    return
  }
}
