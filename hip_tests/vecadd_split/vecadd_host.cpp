...
extern "C" void vecadd_kernel(TYPE* src0, TYPE* src1, TYPE* dst, uint32_t num_points);
...
int main(int argc, char *argv[]) {
  ...
  hipLaunchKernelGGL(vecadd_kernel, dim3(num_blocks), dim3(threads_per_block), 0, 0,
